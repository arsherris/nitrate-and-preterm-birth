...
## continuous exposure: sibling sample
  ...
  save(mod_sibs_early_conc, mod_sibs_late_conc, 
       file = "output/results/primary/mods_sibs_continuous.RData")
...
## continuous exposure: individual-level sample
  ...
  save(mod_case_control_early_conc, mod_case_control_late_conc, file = "output/results/secondary/2_cohort/mods_continuous.RData" )
...
## continuous exposure: sibling sample without maternal movement
  ...
  save(mod_same_pws_early_conc, mod_same_pws_late_conc, 
       file = "output/results/secondary/1_movement/mods_continuous_same_pws.RData")
